...
---
# <a name="manage-a-proforma-invoice"></a>Xestionar unha factura proforma
...
| **Empresa de recursos** | Definido por defecto a partir do dato real de orixe. Un campo de só lectura que está bloqueado para a edición. | O campo pódese editar nun novo detalle de liña de factura que non se apoia nun dato real de orixe. |
