...
description: Este artigo ofrece a información de solución de problemas necesaria cando se traballa na grade de tarefas.
author: ruhercul
ms.date: 07/22/2022
ms.topic: article
ms.product: ''
...
A grade Tarefa utilizada por Dynamics 365 Project Operations é un iframe aloxado dentro de Microsoft Dataverse. Como resultado deste uso, débense cumprir requisitos específicos para garantir que a autenticación e a autorización funcionan correctamente. Este artigo describe os problemas frecuentes que poden afectar a capacidade de representar a grade ou xestionar tarefas na estrutura de subdivisión do traballo (WBS).
...
No seu exploradorr, abre un novo separador, vaia a project.microsoft.com e inicie sesión co rol de usuario que está a usar para acceder a Project Operations. É importante que só un usuario inicie sesión nun produto de Microsoft no explorador. A mensaxe de erro "login.microsoftonline.com negouse a conectarse" ocorre con máis frecuencia cando máis dun usuario está conectado, como se mostra na seguinte ilustración.

![Escolla unha páxina de inicio de sesión na conta que mostre que dous usuarios iniciaron sesión.](media/MULTIPLE_USERS_LOGGED_IN.png)
