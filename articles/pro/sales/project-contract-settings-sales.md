---
title: Detalles da cabeceira para contratos de proxecto
description: Este artigo ofrece información sobre os campos e a información sobre os contratos do proxecto en Operacións do proxecto.
author: rumant
ms.date: 03/08/2022
ms.topic: article
...
| Cantidade rexistrada | Detalle dunha liña baseada en proxecto | Tempo: A cantidade dos datos reais de custo de tempo total para un rol no proxecto que está asignado a esta liña de contrato. Gastos: Todas as cantidades para esta categoría de gasto nos datos reais de custo de gasto no proxecto asígnanse a esta liña de contrato. |
