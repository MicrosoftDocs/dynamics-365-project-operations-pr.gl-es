...
| Prezo por unidade | O prezo unitario predeterminado utiliza a combinación de **Produto** e **Unidade** valores da lista de prezos do proxecto que é aplicable á data de transacción da liña de factura do provedor. | Nada |
