...
- Se está a crear un novo modelo, debe engadir a columna para admitir o tempo e os gastos entre empresas. Seleccione **Engadir columna condicional** e escriba un nome para a columna, como **LegalEntity**. Introduza unha condición para a columna, onde, se **msdyn\_contractorganizationalunitid.msdyn\_nome** é \<unidade organizativa\>, entón \<introducir persoa xurídica\>; else null.
...
[![Asignación de modelos](./media/ActualsMapping.jpg)](./media/ActualsMapping.jpg)

[![Asignación de modelos](./media/TransactionConnections.jpg)](./media/TransactionConnections.jpg)
...
[![Asignación de modelos](./media/ActualsUpdateMapping.jpg)](./media/ActualsUpdateMapping.jpg)

[![Asignación de modelos](./media/TransactionConnectionsUpdate.jpg)](./media/TransactionConnectionsUpdate.jpg)
