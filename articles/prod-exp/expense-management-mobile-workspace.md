...
description: Este artigo ofrece información sobre o espazo de traballo móbil de xestión de gastos. Esta área de traballo permite aos usuarios capturar e cargar un recibo para que poidan anexalo a un informe de gastos máis tarde. Os usuarios tamén poden crear rapidamente unha liña de gasto mediante un recibo anexo e crear e xestionar os seus informes de gastos.
author: suvaidya
ms.date: 12/01/2017
ms.topic: article
...
- Tira unha foto dun recibo e cárgao en Dynamics 365 Finance. Despois pode anexar esa foto a un informe de gastos máis tarde.
...
## <a name="download-and-install-the-dynamics-365-for-operations-mobile-app"></a>Descargar e instalar a aplicación móbil Dynamics 365 for Operations
...
5. Despois de iniciar sesión, móstranse as áreas de traballo dispoñibles para a súa empresa. Teña en conta que se o administrador do sistema publica unha nova área de traballo máis tarde, terá que actualizar a lista de áreas de traballo móbiles.
