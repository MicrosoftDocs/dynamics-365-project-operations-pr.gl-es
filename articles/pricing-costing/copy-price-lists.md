...
1. Nos separadores **Rol** , **Categoría** , e **Elemento da lista de prezos** dunha lista de prezos, pode seleccionar **Actualizar prezos** para aplicar unha marca para todos os prezos da subgrade. 
