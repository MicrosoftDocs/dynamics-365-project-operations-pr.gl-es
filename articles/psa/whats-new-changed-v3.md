...
description: Este artigo fornece información sobre as novidades e as modificacións na versión 3 de Project Service Automation.
ms.custom:
...
Este artigo proporciona información sobre os cambios na interface de usuario (IU), funcionalidade e terminoloxía en Project Service Automation (PSA) entre a versión 2 ou a versión 1 e a versión 3.
