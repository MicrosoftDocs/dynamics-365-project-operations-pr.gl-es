...
---
# <a name="estimate-a-projectbased-contract-line"></a>Estimar unha liña de contrato baseado en proxecto
...
## <a name="create-an-estimate-directly-on-a-projectbased-contract-line"></a>Crear unha estimación directamente nunha liña de contrato baseado en proxecto
...
| **Empresa de recursos** | **Creación rápida** | A empresa de recursos ou a entidade legal que incorre neste custo e proporciona o recurso para traballar nel. | Este campo ten por defecto o detalle da liña de contrato relacionado para os custos que se crean automaticamente. Este campo tamén se usa na recuperación do prezo de custo. |
