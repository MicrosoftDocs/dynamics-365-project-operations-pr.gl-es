...
## <a name="project-sales-leads"></a>Clientes potenciais de vendas de proxecto
...
## <a name="create-a-new-lead-for-a-project-based-deal"></a>Crear un novo cliente potencial para unha oferta baseada en proxecto
