...
Busca recursos para axudarlle a planificar a súa implementación? Consulte estas guías para descargar.
 ...
 [Guía de planificación e rastrexo de proxectos](../project-service/implementation-guides/project-planning-tracking.md)

 [Guía básica de ofertas, prezos e facturación](../project-service/implementation-guides/begin-quoting-pricing-billing.md)

 [Guía avanzada de ofertas, prezos e facturación](../project-service/implementation-guides/adv-quoting-pricing-billing.md)

 [Guía de xestión de recursos](../project-service/implementation-guides/resource-management-guide.md)

 [Guía de informes](../project-service/implementation-guides/reporting-guide.md)

 [Notas para programadores](../project-service/developer-guides/overview-dev-notes-v3.x.md)
...
## <a name="guidance-for-earlier-versions-app-version-2x-or-1x"></a>Guía para as versións anteriores (versión 2.x ou 1.x da aplicación)
 ...
 [Tempo, gastos e colaboración](../project-service/time-expense-collaboration-guide.md)

 [Notas de produtos (versión 2.x ou 1.x da aplicación)](../project-service/white-papers.md)

 [Notas para programadores (versión 2.x da aplicación)](../project-service/developer-guides/add-custom-qoi-forms-v2.x.md)
