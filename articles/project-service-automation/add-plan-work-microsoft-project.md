...
## <a name="upload-a-project-file-to-sharepoint-or-office-groups"></a>Cargar un ficheiro de proxecto a SharePoint ou Grupos de Office  
 Pode cargar o ficheiro de proxecto en SharePoint e localizalo nos Documentos Asociados para o seu proxecto de [!INCLUDE[pn_project_service_auto](../includes/pn-project-service-auto.md)].  Cómpre que o seu administrador configure a xestión de documentos de SharePoint e que o active para a entidade de proxecto. [!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [Configurar a integración de SharePoint](../admin/set-up-sharepoint-integration.md)  

 Pode tamén cargar o ficheiro de Project file en [!INCLUDE[pn_onedrive_for_business](../includes/pn-onedrive-for-business.md)] se ten Grupos de Office configurados. [!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [Colaborar cos seus colegas usando grupos de Office 365](../basics/collaborate-with-colleagues-using-office-365-groups.md)  
