...
## <a name="using-journals-to-record-costs"></a>Utilización de diarios para rexistrar custos

En PSA, os diarios permiten rexistrar custos ou ingresos nas clases de material, tarifa, tempo, gasto ou transacción de impostos. Un diario ten un encabezado, liñas e unha acción **Confirmar**. Este son algúns escenarios nos que podería usar un diario:
