...
description: Este tema explica como se usa o concepto de orixe das transaccións para vincular datos reais aos rexistros orixinais de orixe, como a entrada de tempo, a entrada de gastos ou os rexistros de uso de material.
author: rumant
ms.date: 03/25/2021
ms.topic: article
ms.prod: ''
